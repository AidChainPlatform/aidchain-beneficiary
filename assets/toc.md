...
AidChain is a voucher payment services provider and acts as such by creating, hosting, maintaining and providing our AidChain services to you via the internet. it's simple and fast to transfer Cash Voucher assistance with AidChain. Register beneficiaries, add spendable value to their wallets and they can spend with local vendors as desired or based on specified conditions. Partner NGOs, Donors, and other participants can conveniently onboard new beneficiaries, verify them by projects and credit their wallet with digital tokens or fiat.  
...
1 - Republish material from Chats.cash  
...
if by any means you disclose your login detail to a third party, you must notify us of such action and so confirm any transaction that would be executed by your account subsequently.
