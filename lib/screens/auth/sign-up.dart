  ...
  Future shouldServiceEnabled() async {
    ...
    if (!isAllowed) {
      showDialog(
        ...
        // Keep defaults; don't override to emulator's US location
          // getLocaleData();
    }
    // }
  }
          ...
          SizedBox(
            ...
            child: CustomButton(
              ...
              onTap: () async {
                ...
                final loc = localeInfo['location'] as Map<String, dynamic>?;
                ...
                if (myKey.currentState!.validate() &&
                  ...
                  model.user = BeneficiaryUser(
                    ...
                    location: jsonEncode({
                      'coordinates': (loc?['longitude'] != null && loc?['latitude'] != null)
                          ? [loc?['longitude'], loc?['latitude']]
                          : [],
                      'country': localeInfo['country_name'] ?? "Unknown",
                      'state': localeInfo['state'] ?? "Unknown"
                    }),
                    state: localeInfo['state'] ?? "Unknown",
                  );
